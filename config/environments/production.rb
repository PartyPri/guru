Guru::Application.configure do
  ...
  config.assets.precompile += [ 'masonry.pkgd.js', 'imagesloaded.pkgd.js', 'projects.js' ]
  config.assets.precompile += %w{landing.css}
  config.assets.precompile += %w[active_admin.css active_admin.js active_admin/print.css emails.scss]
