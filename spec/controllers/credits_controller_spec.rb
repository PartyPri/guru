  ...
  describe 'GET new' do
    ...
    context 'when a user is not signed in' do
      ...
      it 'sets a flash notice explaning the error' do
        subject
        expect(flash[:notice]).to include("You must be signed in")
      end
    end
    ...
    context 'when a user is signed in' do
      ...
      context 'when the user is not the reel owner' do
        ...
        it 'sets a flash notice explaning the error' do
          subject
          expect(flash[:notice]).to include("You do not have permission")
        end
      end
    end
  end
      ...
      context 'when the user is reel owner' do
        ...
        context 'when all necessary params are passed in' do
          ...
          it 'has a correct flash notice' do
            subject
            expect(flash[:notice]).to include("Credit added")
          end
        end
