...
ActiveRecord::Schema.define(version: 20160323032303) do
  ...
  create_table "about_interests", force: :cascade do |t|
    t.integer  "about_id"
  ...
  create_table "credits", force: :cascade do |t|
    ...
    t.string   "credit_receiver_email", limit: 255
    t.datetime "created_at",                                    null: false
    t.datetime "updated_at",                                    null: false
    t.integer  "invitation_status",                 default: 0
  end

  add_index "credits", ["credit_receiver_id"], name: "index_credits_on_credit_receiver_id", using: :btree
  add_index "credits", ["reel_id"], name: "index_credits_on_reel_id", using: :btree
  add_index "credits", ["reel_owner_id"], name: "index_credits_on_reel_owner_id", using: :btree
  ...
  create_table "events", force: :cascade do |t|
    ...
    t.string   "special_copy",     limit: 255
  ...
  create_table "notifications", force: :cascade do |t|
    ...
    t.string   "action_taken_on_type", limit: 255
    t.datetime "created_at",                                       null: false
    t.datetime "updated_at",                                       null: false
    t.integer  "credit_id"
  end

  create_table "reel_interests", force: :cascade do |t|
    t.integer  "reel_id"
    t.integer  "interest_id"
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string   "claim_email",              limit: 255
